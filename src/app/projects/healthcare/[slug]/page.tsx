...
export default function HealthcareProjectDetail() {
  const { slug } = useParams<{ slug: string }>();
  const project = healthcareProjects.find((p) => p.slug === slug);
    ...
    <main className="relative w-full min-h-screen bg-[#000000]">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-16 pt-16 pb-32">
        ...
        >
          ...
          >
            <ArrowLeft className="w-4 h-4" /> Healthcare Projects
          </Link>
        </motion.div>
        ...
        >
          ...
          >
            <ArrowLeft className="w-4 h-4" /> All Healthcare Projects
          </Link>
          <Link
            href="/projects"
