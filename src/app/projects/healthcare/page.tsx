...
import { healthcareProjects } from "@/data/projects";
import { ArrowUpRight, ArrowLeft, HeartPulse, Plus } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-24 pt-16 pb-32">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs font-semibold tracking-widest text-emerald-400 uppercase">Domain Expertise</span>
          </div>
          ...
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
            HEDIS quality measures, EDI X12 processing, CMS interoperability, and payer
            analytics — delivered across 80+ US healthcare clients and data from major
            payers including Aetna, Anthem, and Blue Cross Blue Shield.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {healthcareProjects.map((project, index) => (
            ...
            >
              <Link
                href={`/projects/healthcare/${project.slug}`}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-80px" }}
            transition={{ duration: 0.6, delay: healthcareProjects.length * 0.12 }}
          >
